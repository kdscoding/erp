...
class DashboardMonitoringTest extends TestCase
{
    ...
    public function test_dashboard_shows_saved_views_and_action_center(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertSee('Ctrl+K')
            ->assertSee('Create Draft Shipment')
            ->assertSee('Purchase Order')
            ->assertSee('Tracking')
            ->assertSee('Shipment')
            ->assertSee('Distribusi Status PO')
            ->assertSee('Tren PO Bulanan')
            ->assertSee('Distribusi Status Item')
            ->assertSee('Top Supplier Terlambat')
            ->assertSee('Distribusi Status Shipment')
            ->assertSee('Tren Shipment Bulanan')
            ->assertSee('chart.js')
            ->assertSee('chartPoStatusDist')
            ->assertSee('chartMonthlyTrend')
            ->assertSee('chartStatusBreakdown')
            ->assertSee('chartSupplierDelay')
            ->assertSee('chartShipmentStatusDist')
            ->assertSee('chartShipmentMonthlyTrend');
    }
