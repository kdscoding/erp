...
@php($header = 'Summary Outstanding PO')
@php($headerSubtitle = 'Ringkasan outstanding di level PO agar jumlah dokumen dan total kuantitas cepat terbaca.')

@section('content')
    <div class="page-shell">
        <section class="page-head">
            <div class="page-head-main">
                <h2 class="page-section-title">Summary PO</h2>
                <p class="page-section-subtitle">Fokus ke jumlah PO outstanding, total order, total pengiriman, dan sisa outstanding.</p>
            </div>
            <div class="page-actions">
                <a href="{{ route('summary.item', request()->query()) }}" class="btn btn-sm btn-light">Buka Summary Item</a>
                <a href="{{ route('summary.po.export-excel', request()->query()) }}" class="btn btn-sm btn-outline-success">
        ...
        <section class="ui-surface">
            <form method="GET" class="filter-grid">
                ...
                <div class="span-1">
                    <a href="{{ route('summary.po') }}" class="btn btn-light btn-sm w-100">Reset</a>
                </div>
            </form>
        </section>
        ...
        <section class="ui-surface">
            <div class="ui-surface-head">
                <div>
                    <h3 class="ui-surface-title">Outstanding per PO</h3>
                    <div class="ui-surface-subtitle">Satu baris per PO supaya halaman tetap ringan dan cepat discan.</div>
                </div>
            </div>
