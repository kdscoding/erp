                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        @forelse($shipmentDocuments as $document)
                            <tr>
                                <td>
                                    {{ $document->shipment_number }}<br>
                                    <x-status-badge :status="$document->status" scope="shipment" />
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="text-center text-muted">Belum ada dokumen shipment yang siap
                                    diterima.</td>
                            </tr>
                        @endforelse
                    </tbody>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-4">
                            <div class="invoice-box">
                                ...
                                <div class="invoice-value">{{ $selectedShipment->delivery_note_number ?: '-' }}</div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="invoice-box">
                ...
                <tbody>
                    @foreach ($rows as $r)
                        <tr>
                            <td>
                                {{ $r->gr_number }}
                                @if (($r->status ?? null) === \App\Support\DocumentTermCodes::GR_CANCELLED)
                                    <br><x-status-badge status="Cancelled" scope="gr" />
                                @endif
                            </td>
                            ...
                            @if ($mode === 'history')
                                <td><a href="{{ route('receiving.show', $r->id) }}"
