...
<div class="col-md-2"><input class="form-control form-control-sm" name="warehouse_code" placeholder="Kode" required></div>
<div class="col-md-4"><input class="form-control form-control-sm" name="warehouse_name" placeholder="Nama" required></div>
<div class="col-md-4"><input class="form-control form-control-sm" name="location" placeholder="Lokasi"></div>
