        ...
        <section class="ui-surface">
            ...
            <div class="table-wrap table-responsive">
                <table class="table table-hover ui-table data-table-advanced" data-export-title="suppliers">
                    ...
                    <tbody>
                        @forelse($rows as $row)
                            <tr class="{{ !$row->status ? 'row-inactive' : '' }}">
                                <td><div class="doc-number">{{ $row->supplier_code }}</div></td>
                                <td>
                                ...
                                <td>
                                    <form action="{{ route('suppliers.toggle-status', $row->id) }}" method="POST" class="d-inline status-toggle-form">
                                        @csrf
                                        @method('PATCH')
