...
@section('content')
    <div class="page-shell">
        ...
        <div class="filter-tags mb-3">
            ...
            @endif
            <a href="{{ route('items.index') }}" class="tag-clear">Reset semua</a>
        </div>
        @endif
        ...
        <section class="ui-surface">
            ...
            <div class="table-wrap table-responsive">
                <table class="table table-hover ui-table data-table-advanced">
                    ...
                    <tbody>
                        @forelse($rows as $row)
                            <tr class="{{ !$row->active ? 'row-inactive' : '' }}">
                                ...
                                <td>
                                    <form action="{{ route('items.toggle-status', $row->id) }}" method="POST" class="d-inline status-toggle-form">
                                        ...
                                        <label class="status-toggle">
                                            <input type="checkbox" name="status" {{ $row->active ? 'checked' : '' }}
                                                onchange="this.form.submit()">
                                            <span class="toggle-slider"></span>
                                        </label>
                                        <span class="status-text {{ $row->active ? 'text-success' : 'text-muted' }}">
                            ...
                            <tr>
                                <td colspan="6">
                                    <div class="empty-state">
                                        ...
                                        <a href="{{ route('items.create') }}" class="btn btn-primary btn-sm px-4 mt-2">
                                            ⚕ Tambah Item
                                        </a>
                                    </div>
                                </td>
    ...
    {{-- FAB - Add Item --}}
    <a href="{{ route('items.create') }}" class="fab-add" title="Tambah Item">
