...
@section('content')
    <div class="page-shell">
        ...
        <div class="filter-tags mb-3">
            ...
            <a href="{{ route('units.index') }}" class="tag-clear">Reset semua</a>
        </div>
        @endif
                            ...
                            <tr>
                                <td colspan="3">
                                    <div class="empty-state">
                                        ...
                                        <a href="{{ route('units.create') }}" class="btn btn-primary btn-sm px-4 mt-2">
                                            ⚕ Tambah Unit
                                        </a>
                                    </div>
                                </td>
    ...
    {{-- FAB - Add Unit --}}
    <a href="{{ route('units.create') }}" class="fab-add" title="Tambah Unit">
