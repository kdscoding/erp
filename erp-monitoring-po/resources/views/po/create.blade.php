                ...
                <section class="ui-surface po-form-card">
                    ...
                    <div class="po-card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div>
                                <span class="po-status-pill po-status-initial"><strong>Status Awal:</strong> {{ \App\Support\DocumentTermStatus::poStatusLabel(\App\Support\DocumentTermCodes::PO_ISSUED) }}</span>
                            </div>
                        </div>
                        <div class="po-form-grid">
                            <div class="po-field">
                                <label class="field-label" for="poNumberInput">Nomor PO</label>
                                <input type="text" id="poNumberInput" class="form-control form-control-sm" name="po_number" value="{{ old('po_number') }}" placeholder="Kosongkan untuk auto number">
                            ...
                            <div class="po-field po-field-wide" id="notesFieldWrapper" style="display:none">
                                ...
                                <input type="text" id="notesInput" class="form-control form-control-sm" name="notes" value="{{ old('notes') }}" placeholder="Catatan internal (opsional)">
                            </div>
                        </div>
                    ...
                    <div class="po-card-body">
                        <datalist id="item-codes">
                            @foreach ($items as $item)
                                <option value="{{ $item->item_code }}" label="{{ $item->item_code }} — {{ $item->item_name }} ({{ $item->unit_name }})"></option>
                            @endforeach
                        </datalist>
                        ...
                        <div class="po-sticky-action-bar">
                            <a href="{{ route('po.index') }}" class="btn btn-light btn-sm">
