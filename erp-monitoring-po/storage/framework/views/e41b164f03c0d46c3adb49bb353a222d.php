...
<?php $__env->startSection('content'); ?>
    ...
    <div class="dashboard-grid">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($receivingMonthlyTrend): ?>
        <section>
            <div class="chart-section-title">
            ...
            <div class="chart-row">
                ...
                <div class="chart-card">
                    ...
                    <div class="quick-links">
                        ...
                        <a href="<?php echo e(route('tracking.index')); ?>" class="quick-link">Tracking</a>
                        <a href="<?php echo e(route('receiving.index')); ?>" class="quick-link">Receiving</a>
                    </div>
                </div>
            </div>
        </section>
    ...
    <script>
        (function () {
            ...
            const supplierData = <?php echo json_encode($chartSupplierDelay, 15, 512) ?>;
            ...
            const shipStatusLabels = <?php echo json_encode(array_keys($chartShipmentStatusDist), 15, 512) ?>;
            const shipStatusData = <?php echo json_encode(array_values($chartShipmentStatusDist), 15, 512) ?>;
            ...
            const shipMonthLabels = <?php echo json_encode(array_keys($chartShipmentMonthlyTrend), 15, 512) ?>;
            const shipMonthData = <?php echo json_encode(array_values($chartShipmentMonthlyTrend), 15, 512) ?>;
            ...
            const recvMonthLabels = <?php echo json_encode(array_keys($receivingMonthlyTrend), 15, 512) ?>;
            const recvMonthData = <?php echo json_encode(array_values($receivingMonthlyTrend), 15, 512) ?>;
