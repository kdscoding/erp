                    ...
                    <table class="table table-hover ui-table" id="shipment-table">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_2 = true; $__currentLoopData = $activeRowsData ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                ...
                                <tr class="<?php echo e($focusedShipmentId === (int) $r->id ? 'table-success' : ''); ?>" data-shipment-number="<?php echo e(strtolower($r->shipment_number ?? '')); ?>" data-supplier="<?php echo e(strtolower($r->supplier_name ?? '')); ?>" data-po="<?php echo e(strtolower($r->po_numbers ?? '')); ?>" data-delivery-note="<?php echo e(strtolower($r->delivery_note_number ?? '')); ?>" data-invoice="<?php echo e(strtolower($r->invoice_number ?? '')); ?>" data-status="<?php echo e(strtolower($r->status ?? '')); ?>" onclick="navigateToDetail(<?php echo e($r->id); ?>)" style="cursor:pointer">
                                    ...
                                    <td class="text-end" onclick="event.stopPropagation()">
                                        <div class="action-stack">
                                            <a href="<?php echo e(route('shipments.show', $r->id)); ?>" class="btn btn-sm btn-outline-primary inline-action-btn" title="View" onclick="event.stopPropagation()"><i class="fas fa-eye"></i></a>
                ...
                <div class="table-wrap table-responsive">
                    ...
                    <?php else: ?>
                        <table class="table table-hover ui-table">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_2 = true; $__currentLoopData = $candidateItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candidate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        ...
                        <form method="POST" action="<?php echo e(route('shipments.store')); ?>">
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm table-bordered ui-table">
                                    ...
                                    <tbody>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_2 = true; $__currentLoopData = $selectedItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            ...
            <section class="ui-surface">
                ...
                <div class="table-wrap table-responsive">
                    <table class="table table-hover ui-table">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_2 = true; $__currentLoopData = $archiveRowsData ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <tr onclick="navigateToDetail(<?php echo e($r->id); ?>)" style="cursor:pointer">
...
<?php endif; ?></td>
                                    ...
                                    <td class="text-end"><div class="action-stack"><a href="<?php echo e(route('shipments.show', $r->id)); ?>" class="btn btn-sm btn-outline-primary" onclick="event.stopPropagation()">View</a></div></td>
                                </tr>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
    ...
    <script>
        function navigateToDetail(id) { window.location.href = '<?php echo e(route('shipments.show', ':id')); ?>'.replace(':id', id); }
