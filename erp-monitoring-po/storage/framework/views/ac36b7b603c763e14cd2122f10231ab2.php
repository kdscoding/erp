...
<head>
    ...
    <title><?php echo e($title ?? 'LEMON Internal Monitoring'); ?></title>

    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo e(asset('lemon/apple-touch-icon.png')); ?>">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(asset('lemon/favicon-32x32.png')); ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(asset('lemon/favicon-16x16.png')); ?>">
    <link rel="shortcut icon" href="<?php echo e(asset('lemon/favicon.ico')); ?>">
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto align-items-center">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                    ...
                    <li class="nav-item topbar-role">
                        <span class="bc-chip"><?php echo e($roleLabel); ?></span>
                    </li>
                    <li class="nav-item topbar-user">
                        ...
                        <span class="topbar-user-copy">
                            <strong><?php echo e(auth()->user()->nik ?? '-'); ?></strong>
                            <small><?php echo e(auth()->user()->email ?? 'Guest'); ?></small>
                        </span>
                    </li>
                    <li class="nav-item">
        ...
        <aside class="main-sidebar elevation-4">
            <a href="<?php echo e(route('dashboard')); ?>" class="brand-link d-flex align-items-center">
                <img src="<?php echo e(asset('lemon/apple-touch-icon.png')); ?>" alt="LEMON Logo" class="brand-image img-circle elevation-2">
            ...
            <div class="sidebar">
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentUser?->hasAnyRole(['administrator', 'staff'])): ?>
                            <li class="nav-header">Master Data</li>

                        <li class="nav-item">
                            <a href="<?php echo e(route('items.index')); ?>"
                                class="nav-link <?php echo e(request()->routeIs('items.*') ? 'active' : ''); ?>">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('item-categories.index')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('item-categories.*') ? 'active' : ''); ?>">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('units.index')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('units.*') ? 'active' : ''); ?>">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentUser?->hasAnyRole(['administrator', 'staff', 'supervisor'])): ?>
                            <li class="nav-header">Operational</li>

                            <li class="nav-item">
                                <a href="<?php echo e(route('po.index')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('po.*') ? 'active' : ''); ?>">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('tracking.index')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('tracking.*') ? 'active' : ''); ?>">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentUser?->hasAnyRole(['administrator', 'staff'])): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('shipments.index')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('shipments.*') ? 'active' : ''); ?>">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('receiving.index')); ?>"
                                    class="nav-link <?php echo e($receivingDashboardActive ? 'active' : ''); ?>">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentUser?->hasAnyRole(['administrator', 'staff', 'supervisor'])): ?>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('monitoring.index')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('monitoring.*') ? 'active' : ''); ?>">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('traceability.index')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('traceability.*') ? 'active' : ''); ?>">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentUser?->hasRole('administrator')): ?>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('settings.index')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('settings.*') && !request()->routeIs('users.*') ? 'active' : ''); ?>">
        ...
        <div class="content-wrapper">
                ...
                <div class="container-fluid">
                    <div class="page-topbar">
                        <div class="page-title-wrap">
                            <h1 class="page-title"><?php echo e($header ?? 'LEMON Internal Monitoring'); ?></h1>
                            <div class="page-subtitle">
                                <?php echo e($headerSubtitle ?? 'Monitoring purchase order, shipment, receiving, dan proses operasional.'); ?>

                            </div>
                        </div>

                        <div class="page-ribbon">
                            Tanggal Sistem: <?php echo e(now()->timezone('Asia/Jakarta')->format('d-m-Y H:i')); ?> WIB
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="content">
                <div class="container-fluid">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success') && !session('import_success')): ?>
                        <div class="alert alert-success"><?php echo e(session('success')); ?></div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('error') && !session('import_errors')): ?>
                        ...
                        <div class="alert alert-danger">
                            <ul class="mb-0 pl-3">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <li><?php echo e($error); ?></li> <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </ul>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="command-palette-list" id="commandPaletteList">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $commandPaletteItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <a href="<?php echo e($item['route']); ?>" class="command-palette-item" data-command-item
                                data-keywords="<?php echo e(\Illuminate\Support\Str::lower($item['label'] . ' ' . $item['description'])); ?>">
                                <div>
                                    <div class="command-palette-item-label"><?php echo e($item['label']); ?></div>
                                    <div class="command-palette-item-meta"><?php echo e($item['description']); ?></div>
                                </div>
...
<?php /**PATH C:\laragon\www\erp\erp-monitoring-po\resources\views\layouts\erp.blade.php ENDPATH**/ ?>