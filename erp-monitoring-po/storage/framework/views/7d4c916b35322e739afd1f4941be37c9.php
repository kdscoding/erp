...
<td class="text-center">
                                     <span class="badge badge-dark" style="font-size:10px;"><?php echo e($item['monitoring_status'] ?? $item['item_status'] ?? '-'); ?></span>
                                 </td>
<td class="text-center">
