                    ...
                    <form method="POST" action="<?php echo e(route('suppliers.update', $supplier->id)); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control form-control-sm" name="supplier_code"
                                value="<?php echo e(old('supplier_code', $supplier->supplier_code)); ?>" required readonly>
                        </div>

                        <div class="form-group">
                            <label class="field-label">Nama Supplier</label>
                            <input class="form-control form-control-sm" name="supplier_name"
                                placeholder="Nama perusahaan supplier" value="<?php echo e(old('supplier_name', $supplier->supplier_name)); ?>" required>
                        </div>
...
<?php echo $__env->make('layouts.erp', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\erp\erp-monitoring-po\resources\views\masters\suppliers\edit.blade.php ENDPATH**/ ?>