...
<head>
    ...
    <title><?php echo e($title ?? 'LEMON | Login'); ?></title>
...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?php echo e(url('/')); ?>" class="d-flex flex-column align-items-center">
                <img src="<?php echo e(asset('lemon/android-chrome-512x512.png')); ?>" alt="LEMON" class="login-main-mark mb-3">
...
<?php /**PATH C:\laragon\www\erp\erp-monitoring-po\resources\views\layouts\guest.blade.php ENDPATH**/ ?>