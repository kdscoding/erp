...
<form method="<?php echo e($method); ?>" action="<?php echo e($formAction); ?>" class="filter-form <?php echo e($inline ? 'filter-inline' : 'filter-grid'); ?> <?php echo e($class); ?>" <?php echo e($formAttributes); ?>>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $contextFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        ...
        <div class="filter-field <?php echo e($fieldClass); ?>" style="<?php echo e($fieldSpan !== 'auto' ? 'grid-column: span ' . $fieldSpan . ';' : ''); ?>">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($fieldType):
                case ('select'): ?>
                    <select name="<?php echo e($fieldName); ?>" id="filter_<?php echo e($fieldName); ?>" class="form-control form-control-sm" <?php echo e($fieldAttributes); ?>>
                ...
                <?php case ('date'): ?>
                    <input type="date" name="<?php echo e($fieldName); ?>" id="filter_<?php echo e($fieldName); ?>" class="form-control form-control-sm" value="<?php echo e($fieldValue); ?>" <?php echo e($fieldAttributes); ?>>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?><?php break; ?>

                <?php case ('number'): ?>
                    <input type="number" name="<?php echo e($fieldName); ?>" id="filter_<?php echo e($fieldName); ?>" class="form-control form-control-sm" value="<?php echo e($fieldValue); ?>" placeholder="<?php echo e($fieldPlaceholder); ?>" <?php echo e($fieldAttributes); ?>>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?><?php break; ?>

                <?php default: ?>
                    <input type="text" name="<?php echo e($fieldName); ?>" id="filter_<?php echo e($fieldName); ?>" class="form-control form-control-sm" value="<?php echo e($fieldValue); ?>" placeholder="<?php echo e($fieldPlaceholder); ?>" <?php echo e($fieldAttributes); ?>>
