...
<?php $__env->startSection('content'); ?>
    <div class="page-shell">
        ...
        <a href="<?php echo e(route('shipments.bulk-template')); ?>" class="btn btn-light btn-sm mb-3"><i class="fas fa-download"></i> Download Bulk Import Template</a>

        <form method="POST" action="<?php echo e(route('shipments.store')); ?>" id="draftForm">
            <?php echo csrf_field(); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedItems->isNotEmpty()): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $draftQuantities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemId => $qty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <input type="hidden" name="shipped_qty[<?php echo e($itemId); ?>]" value="<?php echo e($qty); ?>">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $draftInvoicePrices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemId => $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <input type="hidden" name="invoice_unit_price[<?php echo e($itemId); ?>]" value="<?php echo e($price); ?>">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <section class="ui-surface wizard-step active" id="step1">
                ...
                <div class="ui-surface-body">
                    <form method="GET" class="shipment-selection-form" action="<?php echo e(route('shipments.create')); ?>" id="candidateFilterForm">
                            ...
                            <div class="span-3">
                                ...
                                <select name="supplier_id" class="form-control form-control-sm" <?php echo e($selectedItems->isNotEmpty() ? 'disabled' : ''); ?>>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <option value="<?php echo e($supplier->id); ?>" <?php if((int) request('supplier_id', $selectedSupplierId) === (int) $supplier->id): echo 'selected'; endif; ?>>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedItems->isNotEmpty()): ?>
                                    <input type="hidden" name="supplier_id" value="<?php echo e($selectedSupplierId); ?>">
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <div class="span-8">
                                <label class="field-label">Cari Item / PO / Supplier</label>
                                <input type="text" name="keyword" value="<?php echo e(request('keyword')); ?>" class="form-control form-control-sm" placeholder="Item code, nama item, nomor PO, nama supplier">
                            </div>
                ...
                <div class="ui-surface-body">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedItems->isNotEmpty()): ?>
                        <div class="info-grid mb-3">
                            <div class="info-box"><div class="info-label">Supplier</div><div class="info-value"><?php echo e($selectedItems->first()->supplier_name); ?></div></div>
                            <div class="info-box"><div class="info-label">Jumlah Item</div><div class="info-value"><?php echo e($selectedItems->count()); ?></div></div>
                            <div class="info-box"><div class="info-label">PO Terkait</div><div class="info-value"><?php echo e($selectedItems->pluck('purchase_order_id')->unique()->count()); ?></div></div>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $selectedItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="doc-meta"><?php echo e($item->po_number); ?></div>
                                                    </td>
                                                    <td><?php echo e(\App\Support\NumberFormatter::trim($item->outstanding_qty)); ?></td>
                                                    <td><?php echo e(\App\Support\NumberFormatter::trim($item->open_shipment_qty)); ?></td>
                                                    <td><?php echo e(\App\Support\NumberFormatter::trim($currentDraftQty)); ?></td>
                                                    <td><?php echo e(\App\Support\NumberFormatter::trim($remainingAfterDraft)); ?></td>
                                                    <td style="min-width: 360px;">
                                                        <div class="shipment-progress-track">
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($shipmentEvents->isEmpty()): ?>
                                                                <div class="doc-meta">Belum ada shipment event lain untuk item ini.</div>
                                                            <?php else: ?>
                                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $shipmentEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                                    ...
                                                                    <div class="shipment-progress-card">
                                                                        <div class="shipment-progress-header">
                                                                            <div>
                                                                                <div class="doc-number"><?php echo e($event->shipment_number); ?></div>
                                                                                <div class="doc-meta"><?php echo e(\Carbon\Carbon::parse($event->shipment_date)->format('d-m-Y')); ?> | DN <?php echo e($event->delivery_note_number ?: '-'); ?></div>
                                                                            </div>
                                                                            <?php if (isset($component)) { $__componentOriginal8c81617a70e11bcf247c4db924ab1b62 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8c81617a70e11bcf247c4db924ab1b62 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.status-badge','data' => ['status' => $event->status,'scope' => 'shipment']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('status-badge'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['status' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($event->status),'scope' => 'shipment']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                                                                        ...
                                                                        <div class="shipment-progress-bar"><div class="shipment-progress-fill" style="width: <?php echo e($receivedPercent); ?>%"></div></div>
                                                                        <div class="shipment-progress-meta">
                                                                            <span>Shipped <?php echo e(\App\Support\NumberFormatter::trim($event->shipped_qty)); ?></span>
                                                                            <span>Received <?php echo e(\App\Support\NumberFormatter::trim($event->received_qty)); ?></span>
                                                                            <span>Open <?php echo e(\App\Support\NumberFormatter::trim($event->open_qty)); ?></span>
                                                                        </div>
                                                                    </div>
                                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                            <div class="shipment-progress-card shipment-progress-card-current">
                                                                ...
                                                                <div class="shipment-progress-bar">
                                                                    ...
                                                                    <div class="shipment-progress-fill shipment-progress-fill-current" style="width: <?php echo e($draftPercent); ?>%"></div>
                                                                </div>
                                                                <div class="shipment-progress-meta">
                                                                    <span>Draft <?php echo e(\App\Support\NumberFormatter::trim($currentDraftQty)); ?></span>
                                                                    <span>Outstanding <?php echo e(\App\Support\NumberFormatter::trim($item->outstanding_qty)); ?></span>
                                                                    <span>Sisa <?php echo e(\App\Support\NumberFormatter::trim($remainingAfterDraft)); ?></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
                    ...
                    <div class="form-card">
                        ...
                        <div class="filter-grid px-0 pt-0 pb-0">
                            <div class="span-4">
                                ...
                                <input type="text" class="form-control form-control-sm" value="<?php echo e(optional($selectedItems->first())->supplier_name ?: '-'); ?>" disabled>
                            </div>
                            <div class="span-3">
                                <div class="field-inline-label">No Delivery Note <span class="text-danger">*</span></div>
                                <input type="text" name="delivery_note_number" value="<?php echo e(old('delivery_note_number')); ?>" class="form-control form-control-sm" placeholder="No surat jalan supplier" required>
                            </div>
                            <div class="span-2">
                                <div class="field-inline-label">Tanggal Dokumen <span class="text-danger">*</span></div>
                                <input type="date" name="shipment_date" value="<?php echo e(old('shipment_date', now()->format('Y-m-d'))); ?>" class="form-control form-control-sm" required>
                            </div>
                            <div class="span-3">
                                <div class="field-inline-label">No Invoice</div>
                                <input type="text" name="invoice_number" value="<?php echo e(old('invoice_number')); ?>" class="form-control form-control-sm" placeholder="Nomor invoice supplier">
                            </div>
                            <div class="span-3">
                                <div class="field-inline-label">Tanggal Invoice</div>
                                <input type="date" name="invoice_date" value="<?php echo e(old('invoice_date')); ?>" class="form-control form-control-sm">
                            </div>
                            <div class="span-2">
                                <div class="field-inline-label">Currency</div>
                                <input type="text" name="invoice_currency" value="<?php echo e(old('invoice_currency', 'IDR')); ?>" class="form-control form-control-sm" maxlength="10" placeholder="IDR">
                            </div>
                            <div class="span-7">
                                <div class="field-inline-label">Catatan</div>
                                <input type="text" name="supplier_remark" value="<?php echo e(old('supplier_remark')); ?>" class="form-control form-control-sm" placeholder="Catatan internal atau info tambahan supplier">
                            </div>
                            <div class="span-4 d-flex align-items-end">
                                <div class="form-check mb-1">
                                    <input class="form-check-input" type="checkbox" value="1" name="po_reference_missing" id="po_reference_missing" <?php if(old('po_reference_missing') === '1'): echo 'checked'; endif; ?>>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $selectedItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="min-width: 140px;">
                                                <input type="hidden" name="selected_items[]" value="<?php echo e($item->purchase_order_item_id); ?>">
                                                <input type="number" step="0.01" min="0.01" max="<?php echo e(\App\Support\NumberFormatter::input($item->available_to_ship_qty)); ?>" name="shipped_qty[<?php echo e($item->purchase_order_item_id); ?>]" value="<?php echo e(\App\Support\NumberFormatter::input(old('shipped_qty.' . $item->purchase_order_item_id, $draftQuantities[$item->purchase_order_item_id] ?? $item->available_to_ship_qty))); ?>" class="form-control form-control-sm draft-qty-input" data-item-id="<?php echo e($item->purchase_order_item_id); ?>" required>
                                            </td>
                                            <td style="min-width: 160px;">
                                                <input type="number" step="0.0001" min="0" name="invoice_unit_price[<?php echo e($item->purchase_order_item_id); ?>]" value="<?php echo e($draftPrice); ?>" class="form-control form-control-sm draft-price-input" data-item-id="<?php echo e($item->purchase_order_item_id); ?>" placeholder="Opsional">
                                            </td>
                                            <td style="min-width: 140px;">
                                                <input type="text" class="form-control form-control-sm bg-light draft-line-total" data-item-id="<?php echo e($item->purchase_order_item_id); ?>" value="-" readonly>
                                            </td>
                                            <td>
                                                <button type="button" class="btn btn-sm btn-outline-danger" onclick="removeDraftItem('<?php echo e($item->purchase_order_item_id); ?>')">Keluarkan</button>
                                            </td>
                                        </tr>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    ...
                    <div class="confirm-summary-box mb-3">
                        <div class="confirm-summary-grid">
                            <div class="confirm-item">
                                <div class="confirm-value"><?php echo e($selectedItems->count()); ?></div>
                                <div class="confirm-label">Line Items</div>
                            </div>
                            <div class="confirm-item">
                                <div class="confirm-value"><?php echo e(\App\Support\NumberFormatter::trim($totalQty)); ?></div>
                                <div class="confirm-label">Total Qty</div>
                            </div>
                            <div class="confirm-item">
                                <div class="confirm-value"><?php echo e(\App\Support\NumberFormatter::trim($totalPrice)); ?></div>
                                <div class="confirm-label">Total Invoice</div>
                            </div>
                            <div class="confirm-item">
                                <div class="confirm-value"><?php echo e($selectedItems->pluck('purchase_order_id')->unique()->count()); ?></div>
                                <div class="confirm-label">PO References</div>
                            </div>
                            <div class="confirm-item">
                                <div class="confirm-value"><?php echo e($selectedItems->first()->supplier_name ?: '-'); ?></div>
                                <div class="confirm-label">Supplier</div>
                            </div>
                            <div class="confirm-item">
                                <div class="confirm-value"><?php echo e(old('delivery_note_number', '-')); ?></div>
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $selectedItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    ...
                                    <tr>
                                        <td><?php echo e($item->po_number); ?></td>
                                        <td><div class="doc-number"><?php echo e($item->item_code); ?></div><div class="doc-meta"><?php echo e($item->item_name); ?></div></td>
                                        <td><?php echo e(\App\Support\NumberFormatter::trim($qty)); ?></td>
                                        <td><?php echo e($price > 0 ? \App\Support\NumberFormatter::trim($price) : '-'); ?></td>
                                        <td><?php echo e($qty * $price > 0 ? \App\Support\NumberFormatter::trim($qty * $price) : '-'); ?></td>
                                    </tr>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </tbody>
                        </table>
            ...
            <div class="sticky-action-bar d-flex justify-content-between align-items-center">
                ...
                <div class="page-actions">
                    <button type="button" class="btn btn-light btn-sm" id="prevStep" onclick="goToStep(<?php echo e(max(1, (int) request('step', 1) - 1)); ?>)" @click="goToStep(prev)" style="display:none">← Back</button>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedItems->isNotEmpty()): ?>
                        <button type="button" class="btn btn-outline-danger btn-sm" onclick="removeCheckedDraftItems()">Keluarkan Item Checklist</button>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <button type="button" class="btn btn-primary btn-sm" id="nextStep" onclick="goToStep(<?php echo e(min(3, (int) request('step', 1) + 1)); ?>)">Next →</button>
                    <button type="submit" class="btn btn-success btn-sm" id="saveDraftBtn" <?php echo e($selectedItems->isEmpty() ? 'disabled' : ''); ?>>Simpan Draft Shipment</button>
                </div>
            </div>
        </form>
    </div>
    ...
    <script>
        ...
        let currentStep = <?php echo e(request('step', 1)); ?>;
        const hasItems = <?php echo e($selectedItems->isNotEmpty() ? 'true' : 'false'); ?>;
        ...
        document.addEventListener('keydown', function(e) {
            if (e.ctrlKey && e.key === 'n') { e.preventDefault(); window.location.href = '<?php echo e(route('shipments.create')); ?>'; }
...
<?php echo $__env->make('layouts.erp', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\erp\erp-monitoring-po\resources\views\shipments\create.blade.php ENDPATH**/ ?>