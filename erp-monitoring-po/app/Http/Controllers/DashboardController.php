...
=======
            'items_pending_etd' => DB::table('purchase_order_items as poi')
                ...
                ->count(),
            'late_items' => DB::table('purchase_order_items as poi')
                ->join('purchase_orders as po', 'po.id', '=', 'poi.purchase_order_id')
                ->where('poi.outstanding_qty', '>', 0)
                ->whereNotNull('poi.eta_date')
...
>>>>>>> theirs
        ...
        return view('dashboard', compact('metrics', 'supplierDelay', 'openPoList', 'recentReceivings', 'atRiskItems'));
    }
}
